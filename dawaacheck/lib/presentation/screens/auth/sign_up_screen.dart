  ...
  Future<void> _signUp() async {
    ...
    if (!_agreeToTerms) {
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(content: Text(AppStrings.agreeToTerms)),
      );
      return;
    }
          ...
          child: Form(
            ...
            child: Column(
              ...
              const SizedBox(height: 20),
                ...
                Text(AppStrings.createAccount, style: AppTextStyles.h2, textAlign: TextAlign.center)
                    .animate()
                    .fadeIn(delay: 100.ms, duration: 400.ms)
                    .slideY(begin: 0.1, end: 0, delay: 100.ms, duration: 300.ms, curve: Curves.easeOutCubic),
                const SizedBox(height: 8),
                Text(
                  AppStrings.joinMillions,
                ...
                Row(
                  mainAxisAlignment: MainAxisAlignment.center,
                  children: [
                    Text(AppStrings.alreadyHaveAccount, style: AppTextStyles.body.copyWith(color: AppColors.textHint)),
                    TextButton(
                      onPressed: () {
                        HapticFeedback.lightImpact();
                        context.go('/sign-in');
                ...
                Center(
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(
                        'ANONYMOUS \u00B7 NO PHI STORED \u00B7 DRAP-SCOPED',
